        ...
        <div className="container-page grid gap-10 lg:grid-cols-3">
          ...
          <aside className="lg:sticky lg:top-24 h-fit">
            <div className="rounded-2xl border border-border bg-card p-6 shadow-sm">
              ...
              <a href="https://wa.me/254746011254" className="mt-2 flex w-full items-center justify-center rounded-full border border-[#25D366] px-6 py-3 text-sm font-semibold text-[#25D366] hover:bg-[#25D366]/10">
                WhatsApp Us
              </a>
            </div>
          </aside>
