    ...
    <div className="bg-[#FAF7F2] min-h-screen pb-10">
      <div className="relative h-[88vh] bg-black overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
          ...
          <p className="mt-3 text-white/60 text-[10px]">Deposit ${dep} • {paybillAcc} • {(packageData as any).rating || ""}</p>
        </div>
      </div>
              ...
              <>
                ...
                <div className="p-5">
                  ...
                  <div className="mt-3 bg-black rounded-xl p-4 text-white flex justify-between items-center">
                    <div><p className="text-[12px] font-bold">Juma Adventures. • Business</p><p className="text-[10px] text-white/50">+254 746 011254 • 06:00-18:00</p></div>
